...
/**
 * Reads zones based on provided parameters (customer context)
 * Note: Zones are typically not customer-specific, but this provides a consistent interface
 */
...
/**
 * Creates a new zone (customer context)
...
/**
 * Updates a zone based on provided parameters (customer context)
